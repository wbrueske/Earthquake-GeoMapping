...
// PB2002_boundaries.json sourced from https://github.com/fraxen/tectonicplates
// License: https://github.com/fraxen/tectonicplates/blob/master/LICENSE.md
// // This collection of data is made available under the Open Data Commons Attribution License: http://opendatacommons.org/licenses/by/1.0/
import plateBoundaries from './PB2002_boundaries.json' with { type: 'json' };
...
var light = L.tileLayer(
  'https://api.mapbox.com/styles/v1/mapbox/light-v11/tiles/512/{z}/{x}/{y}?access_token={accessToken}',
  {
    attribution:
      'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 18,
    accessToken:
      'pk.eyJ1Ijoid2JydWVza2UiLCJhIjoiY2p0Ym1jbHR3MG43azN5cDRud3NrajY4aSJ9.MY-Vm852vmNh92n0letPAw',
  }
);
...
legend.onAdd = function (map) {
  ...
  div.innerHTML = `<span class="title">Magnitude</span>`;
